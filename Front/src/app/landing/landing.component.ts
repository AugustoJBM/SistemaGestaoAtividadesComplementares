  ...
  readonly modalidades = [
    {
      ...
      categorias: [
        ...
        'Eventos e Congressos Acadêmicos',
      ],
    },
    {
      sigla: 'ACEX',
      ...
      horasExigidas: 320,
      descricao:
        'Ações contínuas de extensão universitária em diálogo direto com a comunidade e a sociedade.',
      categorias: [
        'Projetos de Extensão',
        'Programas e Cursos Comunitários',
  ...
  readonly cicloDeVida: EtapaFluxo[] = [
    {
      ...
      subtitulo:
        'O estudante registra a atividade e anexa o certificado digital em PDF, PNG ou JPEG.',
      icone: 'upload_file',
      status: 'ENVIADO',
    },
    {
      ...
      subtitulo:
        'Avaliadores e monitores verificam a autenticidade, carga horária e compatibilidade com a categoria.',
      icone: 'fact_check',
      status: 'EM AVALIAÇÃO',
    },
    {
      ...
      subtitulo:
        'Após a aprovação, as horas válidas são consolidadas automaticamente no dashboard de progresso.',
      icone: 'verified',
      status: 'APROVADO',
    },
    {
      ...
      subtitulo:
        'Geração de relatório discriminado e formalizado para integralização da carga horária acadêmica.',
      icone: 'description',
  ...
  readonly modulosSistema: ModuloDestaque[] = [
    {
      ...
      descricao:
        'Acesso seguro por e-mail institucional ou matrícula com controle de permissões baseado em papéis (RBAC).',
      tag: 'Segurança',
    },
    {
      icone: 'library_books',
    ...
    },
    {
      ...
      descricao:
        'Armazenamento seguro de documentos comprobatórios com pré-visualização integrada de arquivos.',
      tag: 'Documentos',
    },
    {
      icone: 'monitoring',
      ...
      descricao:
        'Monitoramento detalhado de horas aprovadas, pendências em análise e percentual de conclusão das metas.',
      tag: 'Progresso',
    },
    {
      icone: 'article',
      ...
      descricao:
        'Consolidação das atividades com identificação oficial do estudante e data de emissão para a coordenação.',
      tag: 'Relatórios',
    },
    {
      ...
      descricao:
        'Comunicação sobre o andamento das solicitações, aprovações e eventuais pedidos de ajuste.',
      tag: 'Notificações',
    },
  ];
