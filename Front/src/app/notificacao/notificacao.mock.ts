...
export let NOTIFICACOES_MOCK: Notificacao[] = [
    {
        ...
        mensagem: 'Sua solicitação #7 de validação de atividades complementares (ACC) foi aprovada integralmente pela comissão.',
        solicitacaoId: 7,
        lida: false,
    ...
    },
    {
        ...
        mensagem: 'O avaliador solicitou ajuste no comprovante do item "Projeto de Extensão": anexo ilegível ou incompleto.',
        solicitacaoId: 8,
        lida: false,
    ...
    },
    {
        ...
        mensagem: 'A solicitação #6 foi rejeitada pois ultrapassou o prazo regulamentar do semestre letivo.',
        solicitacaoId: 6,
        lida: true,
