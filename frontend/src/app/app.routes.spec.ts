...
describe('routes', () => {
  ...
  it('deve proteger a rota dashboard com authGuard e roleGuard', () => {
  ...
  it('deve proteger a rota regulamentos/gestao com authGuard e roleGuard', () => {
    ...
    expect(regulamentos?.canActivate).toContain(authGuard);
  });

  it('deve proteger a rota relatorio com authGuard e roleGuard', () => {
  ...
  it('deve proteger a rota solicitacoes com authGuard e roleGuard', () => {
  ...
  it('deve proteger a rota notificacoes com authGuard e roleGuard', () => {
    const rota = routes.find((r: Route) => r.path === 'notificacoes');
    expect(rota).toBeTruthy();
    expect(rota?.canActivate?.length).toBe(2);
    expect(rota?.canActivate).toContain(authGuard);
  });
