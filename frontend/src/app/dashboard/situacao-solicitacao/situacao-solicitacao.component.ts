      ...
      <div class="bg-white p-6 rounded-lg shadow-md border border-gray-200 mb-6">
        @if (!solicitacaoMaisRecente()) {
          ...
          <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
            <div>
              <span
                class="inline-block bg-yellow-100 text-yellow-800 text-xs px-2.5 py-0.5 rounded font-semibold mb-1"
              >
          ...
          <div
            class="bg-red-50 border-l-4 border-red-500 p-4 rounded flex flex-col sm:flex-row justify-between items-center gap-4"
          >
            <div>
              <span
                class="inline-block bg-red-100 text-red-800 text-xs px-2.5 py-0.5 rounded font-semibold mb-1"
              >
