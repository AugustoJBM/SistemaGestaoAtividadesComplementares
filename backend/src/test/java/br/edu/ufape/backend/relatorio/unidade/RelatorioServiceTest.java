package br.edu.ufape.backend.relatorio.unidade;
...
class RelatorioServiceTest {
	...
	private AtividadeResponseDTO atividade(Long id, Natureza natureza, Categoria categoria, int horas) {
		return new AtividadeResponseDTO(id, "Atividade " + id, "UFAPE", LocalDate.of(2026, 3, 10), horas, natureza,
				categoria, LocalDateTime.of(2026, 3, 11, 9, 0), EMAIL);
	}
