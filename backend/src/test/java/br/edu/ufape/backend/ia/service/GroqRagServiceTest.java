...
class GroqRagServiceTest {
	...
	void deveRetornarParecerInconclusivoSemChave() {
		...
		ParecerResponseDTO parecer = service.gerarParecerComContextoRAG("Monitoria", "UFAPE", "ACC", "ENSINO", 30,
				"Art. 12: Monitoria até 40h");
	...
	void deveGerarParecerComRespostaJsonValida() {
		...
		ParecerResponseDTO parecer = service.gerarParecerComContextoRAG("Projeto Social", "UFAPE", "ACEX", "EXTENSAO",
				40, "Art. 14 Extensao");
	...
	void deveProcessarParecerComFallbackRegex() {
		...
		ParecerResponseDTO parecer = service.gerarParecerComContextoRAG("PIBIC", "UFAPE", "ACC", "PESQUISA", 20,
				"Art. 13 PIBIC");
