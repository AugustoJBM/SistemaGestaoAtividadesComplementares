...
public interface AtividadeComplementarRepository extends JpaRepository<AtividadeComplementar, Long> {
	...
	List<AtividadeComplementar> findByEstudanteAndNaturezaAndCategoria(Usuario estudante, Natureza natureza,
			Categoria categoria);

	Optional<AtividadeComplementar> findByIdAndEstudante(Long id, Usuario estudante);

	default List<AtividadeComplementar> findByEstudanteComFiltros(Usuario estudante, Natureza natureza,
			Categoria categoria) {
