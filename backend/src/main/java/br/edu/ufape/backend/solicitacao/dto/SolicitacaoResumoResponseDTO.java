...
public record SolicitacaoResumoResponseDTO(Long id, StatusSolicitacao status, LocalDateTime dataSubmissao,
		LocalDateTime dataAvaliacao, Long totalAtividades) {
