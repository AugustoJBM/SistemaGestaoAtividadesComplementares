...
public class RegulamentoDataInitializerService implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) {
		try {
			...
			List<RegulamentoChunk> chunks = List.of(new RegulamentoChunk("Art. 12",
	...
	private void salvarChunkComEmbedding(RegulamentoChunk chunk) {
		try {
