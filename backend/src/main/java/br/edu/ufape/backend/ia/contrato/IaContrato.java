...
public interface IaContrato {
	...
	/**
	 * Executa RAG semântico contra os regulamentos da UFAPE e emite parecer
	 * técnico.
	 */
	ParecerResponseDTO gerarParecerConformidade(String titulo, String instituicao, String natureza, String categoria,
			int cargaHoraria);
}
