...
public record SolicitacaoDetalheResponseDTO(Long id, StatusSolicitacao status, LocalDateTime dataSubmissao,
		LocalDateTime dataAvaliacao, String justificativa, List<SolicitacaoAtividadeResponseDTO> itens,
		Integer totalAtividades) {

	public SolicitacaoDetalheResponseDTO(SolicitacaoValidacao solicitacao) {
		this(solicitacao.getId(), solicitacao.getStatus(), solicitacao.getDataSubmissao(),
				solicitacao.getDataAvaliacao(), solicitacao.getJustificativa(),
